    ...
    <div class="transbox">
        ...
        <div class="container">
            <form action="setpwd" method="post">
                <div><h3>请数入原密码...</h3></div>
                原密码：<input type="text" placeholder="请输入原密码" name="oldpwd">
                <h3 style="color: red">${setpwderror}</h3>
                <br>
                <br>
                新密码：<input type="text" placeholder="请输入修改的密码" name="newpwd">
                <br>
                <br>
