...
<nav class="navbar navbar-default " role="navigation" style="position: sticky;top: 0;background-color:darkturquoise;z-index:999">
    <div class="container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand" href="zhuye1">YGJ商城</a>
        </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-2 col-xs-2">
                            <div class="navbar-header">
                                <a class="navbar-brand" href="zhuye1">首页</a>
                            </div>
                        </div>
                        <div class="col-md-2 col-xs-2">
                            <div class="navbar-header">
...
<%
    ...
    request.getSession().setAttribute("proimg",list);
        ...
        <div class="col-md-1 col-xs-1">
            <ul class="nav nav-pills nav-stacked">
                <c:forEach items="${getalltype}" var="modelss" varStatus="id1">
                    <li><a href="pro1.do?name=${modelss.getTypeId()}">${modelss.getTypeName()}</a></li>
                </c:forEach>
            </ul>
        </div>
